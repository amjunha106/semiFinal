...
<header class="header33">
    ...
    <main class="main33">
        ...
        <p class="ppap33">
		<input name="m_id" class="input33" value="${mem.m_id }" readonly/>
		</p>
        
        <p class="ppap33">
            <input type="password" name="m_pwd" class="input33" value="${mem.m_pwd }"/>
        </p>
        ...
        <p class="ppap33">
            <input type="text" name="m_name" class="input33" value="${mem.m_name }"/>
        </p>
        
        <p class="ppap33">
            <input type="text" name="m_email" class="input33" value="${mem.m_email }"/>
        </p>
        
        <p class="ppap33">
            <input type="text" name="m_number" class="input33" value="${mem.m_number }"/>
        </p>
        
        <p class="ppap33">
            <input type="number" name="m_age" class="input33" value="${mem.m_age }"/>
        </p>
...
<script type="text/javascript">
    ...
    $("#delBtn").click(function(){
    	if(confirm("탈퇴하시겠습니까?")){
			...
			*/	    	
    		location.href="memDelete100.do?m_id="+$("[name=m_id]").val()	
    	}
    })
</script>
</body>
